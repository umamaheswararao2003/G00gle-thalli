// Benchmark: MatMul 1024x1024 (Compute-Bound)
// Operation: Matrix multiplication
// Arithmetic Intensity: ~213 FLOPS/byte (highly compute-bound)
// Target: ~7,000 GFLOPS (54% of peak)

module {
  func.func @bench_matmul_1024(%arg0: tensor<1024x1024xf32>, %arg1: tensor<1024x1024xf32>) -> tensor<1024x1024xf32> {
