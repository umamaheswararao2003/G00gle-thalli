// Benchmark: MatMul 2048x2048 (Compute-Bound)
// Operation: Matrix multiplication
// Arithmetic Intensity: ~256 FLOPS/byte (highly compute-bound)
// Target: ~10,000 GFLOPS (77% of peak)

module {
  func.func @bench_matmul_2048(%arg0: tensor<2048x2048xf32>, %arg1: tensor<2048x2048xf32>) -> tensor<2048x2048xf32> {
    %0 = google.matmul %arg0, %arg1 : tensor<2048x2048xf32>, tensor<2048x2048xf32> -> tensor<2048x2048xf32>
