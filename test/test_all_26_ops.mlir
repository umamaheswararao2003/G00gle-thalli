// FINAL COMPREHENSIVE TEST: All 26 Working Operations
...
module {
  ...
  // Shape operations (3)
  func.func @test_shape_ops(%arg0: tensor<4x8x16xf32>, %arg1: tensor<32x128xf32>, %arg2: tensor<8xf32>) -> (tensor<16x4x8xf32>, tensor<32x40xf32>, tensor<4x8xf32>) {
    ...
    return %0, %1, %2 : tensor<16x4x8xf32>, tensor<32x40xf32>, tensor<4x8xf32>
  }
